...
class NANDGate : public Circuit<2,0,0,1,0,0> {
  public:
    NANDGate() {
      this->init();
      this->components_.push_back(
		std::make_shared<NAND>(	( this->bit_cin_[0] )->release_output(0),
...
std::string expectedOutput = "1 1 1 0 ";
