...
ByteAdder::ByteAdder(ptr_t inbit, ptr32_t sumA, ptr32_t sumB) {
  ...
  circuit_components_[2] = 
				std::make_shared<FullAdder>(inbit, 
							circuit_components_[0]->release_output(0), 
							circuit_components_[1]->release_output(0));
  circuit_components_[3] = 
				std::make_shared<FullAdder>(circuit_components_[2]->release_output(1), 
							circuit_components_[0]->release_output(1), 
							circuit_components_[1]->release_output(1));
  circuit_components_[4] =
				std::make_shared<FullAdder>(circuit_components_[3]->release_output(1),
							circuit_components_[0]->release_output(2),
							circuit_components_[1]->release_output(2));
  circuit_components_[5] =
				std::make_shared<FullAdder>(circuit_components_[4]->release_output(1),
							circuit_components_[0]->release_output(3),
							circuit_components_[1]->release_output(3));
  circuit_components_[6] =
				std::make_shared<FullAdder>(circuit_components_[5]->release_output(1),
							circuit_components_[0]->release_output(4),
							circuit_components_[1]->release_output(4));
  circuit_components_[7] =
				std::make_shared<FullAdder>(circuit_components_[6]->release_output(1),
							circuit_components_[0]->release_output(5),
							circuit_components_[1]->release_output(5));
  circuit_components_[8] =
				std::make_shared<FullAdder>(circuit_components_[7]->release_output(1),
							circuit_components_[0]->release_output(6),
							circuit_components_[1]->release_output(6));
  circuit_components_[9] =
				std::make_shared<FullAdder>(circuit_components_[8]->release_output(1),
							circuit_components_[0]->release_output(7),
							circuit_components_[1]->release_output(7));
  circuit_components_[10] =
				std::make_shared<ByteMaker>(circuit_components_[2]->release_output(0),
