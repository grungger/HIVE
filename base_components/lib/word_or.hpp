 ...
 * @file word_or.hpp
 *
 * @brief Implementation of ByteOr and WordOr.
 *********************************/
// Includes:
...
/**
 * @brief ByteOr implements the bitwise version of 
 *   the logic gate Or for bytes.
 */
...
/**
 * @brief WordOr implements the bitwise version of
 *   the logic gate Or for words.
 */
class WordOr : public wordMicroCircuit<0,0,2,0,0,1,35> {
  public:
    /**
     ...
     */
    WordOr(ptr32_t inA=ground32, ptr32_t inB=ground32);
