...
ByteNor::ByteNor(ptr8_t inA, ptr8_t inB) {
  ...
  circuit_components_[2] = std::make_shared<Nor>(circuit_components_[0]->release_output(0),
						circuit_components_[1]->release_output(0));
  circuit_components_[3] = std::make_shared<Nor>(circuit_components_[0]->release_output(1),
						circuit_components_[1]->release_output(1));
  circuit_components_[4] = std::make_shared<Nor>(circuit_components_[0]->release_output(2),
						circuit_components_[1]->release_output(2));
  circuit_components_[5] = std::make_shared<Nor>(circuit_components_[0]->release_output(3),
						circuit_components_[1]->release_output(3));
  circuit_components_[6] = std::make_shared<Nor>(circuit_components_[0]->release_output(4),
						circuit_components_[1]->release_output(4));
  circuit_components_[7] = std::make_shared<Nor>(circuit_components_[0]->release_output(5),
						circuit_components_[1]->release_output(5));
  circuit_components_[8] = std::make_shared<Nor>(circuit_components_[0]->release_output(6),
						circuit_components_[1]->release_output(6));
  circuit_components_[9] = std::make_shared<Nor>(circuit_components_[0]->release_output(7),
...
const std::string ByteNor::gate_name = "ByteNor";
