...
b_or.compute_output();
b_neg.compute_output(); // 1
b_not.compute_output(); // 0
...
WordOr w_or(inwA.release_word_output(0), inwB.release_word_output(0));
WordNeg w_neg(inwA.release_word_output(0));
WordNot w_not(inwA.release_word_output(0));
...
w_or.compute_output();
w_neg.compute_output(); // 4294967295 - 18
w_not.compute_output(); // 4294967295 - 19
...
w_nor.compute_output();
w_or.compute_output();
w_neg.compute_output(); // 2
w_not.compute_output(); // 1
...
w_or.print_out(); // Expected: 'bw4294967295 '
w_neg.print_out(); // Expected: 'bw2 '
w_not.print_out(); // Expected: 'bw1 '
