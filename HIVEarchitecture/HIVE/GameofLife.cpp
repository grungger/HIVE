...
int main() {
	...
	std::vector<std::uint32_t> program{
		...
		immediatefull+1+d1*128,
		copyR0toDisp,
		copy+dram+d1*12,
		comp+7+s1*128+s1+d1*12,
		copy+s1*3+d1*12, // i+=1
		copy+s1*128+d1*17, // 0 to Disp <- loop, line 6
		copy+dram+s1*128+d1*12, // 0 to RAM[i]
		comp+7+s1*128+s1+d1*12,
		copy+s1*3+d1*12, // i+=1
		immediate1b*6,
		cond+5+s1*12+d1*128+d1*8, // if i < 8 go to line 6
		immediatefull+128, // 2^7 to Reg0
		...
		copyR0toDisp,
		copy+dram+s1*0+d1*12,
		comp+7+s1*128+s1+d1*12, // Line 20
		copy+s1*3+d1*12, // i+=1
		immediatefull+128+64+d1*28,
		copyR0toDisp,
		copy+dram+s1*0+d1*12,
		comp+7+s1*128+s1+d1*12,
		copy+s1*3+d1*12, // i+=1
		// for i=11,i<15,i++ ->save i tmp in Reg12
		copy+s1*128+d1*17, // <- loop, line 27
		comp+7+s1*128+s1+d1*12,
		copy+s1*3+d1*12,
		immediate1b*27,
		cond+5+s1*12+d1*128+d1*15,
		immediatefull+1+d1*128,
		copyR0toDisp,
		copy+dram+d1*12,
		comp+7+s1*128+s1+d1*12,
		copy+s1*3+d1*12, // i+=1
		flush, // line x=37 (prev 24)
		// Loop 
